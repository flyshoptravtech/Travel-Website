...
import demoUser from "../../assets/img/team-1.jpg"
            ...
            <div className="container">
                ...
                <div className="col-xl-4 col-lg-4 col-md-12">
                    ...
                    <div className="card-top bg-primary position-relative">
                        <div className="position-absolute end-0 top-0 mt-4 me-3"><Link to="#" className="square--40 circle bg-light-dark text-light"><i className="fa-solid fa-right-from-bracket" /></Link></div>
                        <div className="py-5 px-3">
                        <div className="crd-thumbimg text-center">
                            <div className="p-2 d-flex align-items-center justify-content-center brd"><img src={demoUser} className="img-fluid circle" width={120} alt="true" /></div>
                        </div>
                    ...
                    <div className="card-middle mt-5 mb-4 px-4">
                        ...
                        <button className="btn btn-primary fw-medium full-width rounded-2" type="button"><i className="fa-solid fa-sun me-2" />Upgrade Pro</button>
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    <div className="card-body">
                        ...
                        <div className="col-xl-12 col-lg-12 col-md-12 mb-4">
                            ...
                            <label className="position-relative me-4" htmlFor="uploadfile-1" title="Replace this pic">
                                ...
                                <img id="uploadfile-1-preview" className="avatar-img rounded-circle border border-white border-3 shadow" src={demoUser} alt="true" />
                                </span>
                            </label>
                            {/* Upload button */}
                            <label className="btn btn-sm btn-primary px-4 fw-medium mb-0" htmlFor="uploadfile-1">Change</label>
